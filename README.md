...
*Important: Use the same `encrypted_key` across all sessions. If the key changes, previously stored tokens cannot be decrypted and will return `null` or `false`*  
